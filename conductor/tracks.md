...
*Link: [./conductor/tracks/historical_coverage_breadth_integration_20260705/](./conductor/tracks/historical_coverage_breadth_integration_20260705/)*
- Builds a HathiTrust-side Hansard coverage bridge that feeds cross-repo historical completeness work in `corpus-nz-hansard`.

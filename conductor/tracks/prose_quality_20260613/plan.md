...
- [ ] Task: Write automated test script to check that linters (`typos`, `taplo`, `actionlint`) can execute successfully.
- [ ] Task: Integrate quality check tasks (`lint`, `format-check`, `spell`, `toml-check`, `workflow-syntax`) into the environment commands.
- [ ] Task: Conductor - User Manual Verification 'Phase 2: Quality Command Integration' (Protocol in workflow.md)
